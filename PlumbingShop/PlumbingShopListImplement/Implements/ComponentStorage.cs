...
namespace PlumbingShopListImplement.Implements
{
    public class ComponentStorage : IComponentStorage
    {
        ...
        public List<ComponentViewModel> GetFullList()
        {
            ...
            foreach (var component in source.Components) result.Add(CreateModel(component));
            return result;
        }
        ...
        public List<ComponentViewModel> GetFilteredList(ComponentBindingModel model)
        {
            ...
            {
                if (component.ComponentName.Contains(model.ComponentName)) result.Add(CreateModel(component));
            }
            return result;
        }
        ...
        public ComponentViewModel GetElement(ComponentBindingModel model)
        {
            ...
            foreach (var component in source.Components)
            {
                if (component.Id == model.Id || component.ComponentName == model.ComponentName) return CreateModel(component);
            }
            return null;
        }
        ...
        public void Insert(ComponentBindingModel model)
        {
            ...
            foreach (var component in source.Components)
            {
                if (component.Id >= tempComponent.Id) tempComponent.Id = component.Id + 1;
            }
        ...
        public void Update(ComponentBindingModel model)
        {
            ...
            foreach (var component in source.Components)
            {
                if (component.Id == model.Id) tempComponent = component;
            }

            if (tempComponent == null) throw new Exception("Элемент не найден");
        ...
        {
            return new ComponentViewModel { Id = component.Id, ComponentName = component.ComponentName };
        }
    }
}
